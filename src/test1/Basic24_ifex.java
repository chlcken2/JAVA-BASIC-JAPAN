...
public class Basic24_ifex {
	...
	public static void main(String[] args) {
		 ...
		 * A, 80이상 B, 70이상 C, 60이상 D, 나머지 f 합격 여부는 80이상이면 합격 그렇지 않으면 불합격 성별은 남자면 1, 여자면
		 * 2를 입력 받는다. 성별 출력은 1이면 남자, 2이면 여자 출력
		 */
		...
		String convertedKorGender = gender == 1 ? "남자" : "여자";
		...
		System.out.println("번호" + "\t이름" + "\t국어" + "\t영어" + "\t수학" + "\t총점" + "\t평균" + "\t학점" + "\t합격여부" + "\t성별");
		System.out.print(bno + "\t" + name + "\t" + korScore + "\t" + engScore + "\t" + mathScore + "\t" + totalScore
				+ "\t" + avgScore + "\t" + studentGrade + "\t" + passedResult + "\t" + convertedKorGender);
